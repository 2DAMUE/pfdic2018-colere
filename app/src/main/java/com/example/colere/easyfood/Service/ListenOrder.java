package com.example.colere.easyfood.Service;
...
import com.example.colere.easyfood.OrderStatus;
import com.example.colere.easyfood.R;
...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        ...
        PendingIntent conteIntent = PendingIntent.getActivity(getBaseContext(), 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        builder.setAutoCancel(true)
                ...
                .setTicker("Eustaquio")
                .setContentInfo("Tu pedido fue subido")
